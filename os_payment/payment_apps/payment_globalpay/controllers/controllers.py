...
class GlobalPayWebhookController(http.Controller):
    ...
    @http.route('/payment/globalpay/access_token', type='json', auth='public')
    ...
    @http.route('/payment/globalpay/store_payment_method', type='json', auth='public', csrf=False, methods=['POST'])
